...
### Project Overview
Высокопроизводительный микросервис на **Go**, разработанный специально для защиты экосистемы [Pixeldays](https://pixeldays.xyz/) от автоматизированных атак. Сервис генерирует динамические графические капчи с использованием алгоритмов наложения шума, исключающих эффективное распознавание через OCR-системы.
